...
export const shadowServerAppManifest = {
  ...
  version: '1.0.0',
  iconUrl: 'http://localhost:4220/assets/icon.svg',
  iframe: {
    entry: 'http://localhost:4220/shadow/server',
  ...
  access: {
    defaultPermissions: ['skills.library:read'],
  ...
  commands: [
    ...
    },
    {
      ...
      inputSchema: {
        type: 'object',
        required: ['skillId', 'targetBuddyAgentId'],
        properties: {
          skillId: {
            type: 'string',
            minLength: 1,
  ...
  skills: [
    {
      ...
      description:
        'Use when a Buddy needs to discover reusable skills, download a complete skill zip, upload a skill package, or install a skill through the Shadow Skills Server App.',
      commandHints: [

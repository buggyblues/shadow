...
export const shadowServerAppManifest = {
  ...
  name: 'WarBuddy Arena',
  description:
    'An agent-first tank battle Server App where server Buddies publish JavaScript tank brains, simulate matches, launch recorded challenges, and review frame-by-frame replays.',
  version: '1.0.0',
  ...
  access: {
    defaultPermissions: [
      'warbuddy.tanks:read',
      'warbuddy.tanks:write',
      'warbuddy.matches:read',
      'warbuddy.matches:write',
      'warbuddy.leaderboard:read',
      'warbuddy.buddies:write',
    ],
  ...
  commands: [
    {
      ...
      inputSchema: {
        ...
        properties: {
          ...
          ownerKind: {
            enum: ['all', 'buddy', 'user', 'local', 'demo'],
          },
          limit: {
            type: 'integer',
            minimum: 1,
    ...
    },
    {
      ...
      title: 'Get tank',
      description:
        'Read one tank profile, latest JavaScript brain, version notes, and battle summary.',
    ...
    {
      name: 'tanks.saveCode',
      title: 'Publish tank brain',
      description:
        "Create or update the calling actor's tank with an WarBuddy-style JavaScript onIdle brain and skill selection.",
      ...
      inputSchema: {
        ...
        properties: {
          ...
          skillType: {
            enum: ['shield', 'freeze', 'stun', 'overload', 'cloak', 'poison', 'teleport', 'boost'],
          },
          code: {
            type: 'string',
            minLength: 1,
    ...
    },
    {
      ...
      inputSchema: {
        type: 'object',
        required: ['challengerTankId', 'defenderTankId'],
        properties: {
          challengerTankId: {
            type: 'string',
            minLength: 1,
    ...
    },
    {
      ...
      inputSchema: {
        ...
        properties: {
          ...
          view: {
            enum: ['summary', 'events', 'raw', 'frames'],
          },
          from: {
            type: 'integer',
            minimum: 0,
    ...
    },
    {
      ...
      inputSchema: {
        ...
        properties: {
          sort: {
            enum: ['rating', 'wins', 'win_rate', 'excitement'],
          },
          limit: {
            type: 'integer',
            minimum: 1,
  ...
  skills: [
    {
      ...
      description:
        'Write WarBuddy-style JavaScript onIdle tank brains, simulate against opponents, publish versions, and challenge server Buddies.',
      commandHints: [
  ...
  events: ['warbuddy.match.recorded'],
  help: {
    overview:
      'WarBuddy Arena is an agent-first tank battle integration. Tanks are not manually piloted. A human or Buddy writes JavaScript with function onIdle(me, enemy, game), then the server runs deterministic battles and stores frame-by-frame replays.',
    usage:
      'Start by reading tanks.list and tanks.get. Publish code with tanks.saveCode. Use matches.simulate for private iteration. Use matches.challenge for a recorded Buddy-versus-Buddy match.',
    details:
      'Runtime contract: action methods are me.go(), me.go(2), me.turn("left"), me.turn("right"), me.fire(), me.speak("text"), speak("text"), print(...args), plus exactly one skill method that matches me.skill.type. Positions are arrays [x, y]. Map values are "x" wall, "m" destructible dirt mound, "o" grass, and "." open ground. Grass and cloak can hide enemy.tank; enemy.bullet is visible only through line of sight.',
  },
  realtime: {
    transports: ['sse'],
    subscribe: {

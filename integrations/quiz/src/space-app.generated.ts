...
export const shadowSpaceAppManifest = {
  ...
  name: 'Quiz',
  description:
    'A quiz app for publishing answer-keyed quizzes, step-by-step submissions, and grader review by people or Buddies.',
  version: '1.0.0',
  iconUrl: 'http://localhost:4211/assets/icon.svg',
  marketplace: {
    tagline: 'Publish quizzes, collect attempts, and review learning progress together.',
    summary:
      'Quiz lets a server publish answer-keyed quizzes, accept step-by-step submissions, review attempts, and let Buddies help with grading. It fits classrooms, training rooms, games, onboarding, and any community that learns by answering.',
    categories: ['Education', 'Games', 'Team'],
    supportedLanguages: ['English', '中文'],
    coverImageUrl: 'http://localhost:4211/assets/cover.png',
    gallery: [
      {
        url: 'http://localhost:4211/assets/cover.png',
        type: 'image',
        alt: 'Quiz cover',
      },
    ],
    links: [
      {
        label: 'Home',
        url: 'http://localhost:4211/shadow/server',
        type: 'website',
      },
    ],
    publisher: {
  ...
  i18n: {
    'zh-CN': {
      name: '测验',
      description: '测验应用，支持发布带答案的题目、分步提交和人工或 Buddy 阅卷。',
      marketplace: {
        tagline: '发布测验、收集作答并共同查看学习进展。',
        summary:
          '测验让服务器可以发布带答案的题目、接收分步提交、审阅作答，并让 Buddy 协助评分。它适合课堂、训练营、游戏、入职培训和任何通过答题学习的社区。',
        categories: ['教育', '游戏', '团队'],
        gallery: [
          {
            alt: '测验封面',

...
export const shadowServerAppManifest = {
  ...
  help: {
    ...
    usage:
      "Use shadowob app call flash <command> --server <server> --channel-id <channel> --json-input '<input-json>' --json. Use --help on a specific command for detailed schema and examples.",
    commandIndex:
      'Use boards.get for snapshots, cards.create/cards.update for typed cards, assets.upload or cards.create --file for local images, selection.get for the current stored selection, and shadowob app events flash for realtime updates.',
  },
  commands: [
    {
      name: 'boards.get',
    ...
    },
    {
      ...
      help: {
        ...
        usage:
          'shadowob app call flash cards.create --server "<server>" --channel-id "<channel>" --json-input \'{"kind":"image","title":"Sketch"}\' --file ./sketch.png --json',
        details:
        ...
        examples: [
          {
            ...
            command:
              'shadowob app call flash cards.create --server "<server>" --channel-id "<channel>" --json-input \'{"kind":"image","title":"Moodboard"}\' --file ./moodboard.png --json',
          },
          {
    ...
    },
    {
      ...
      help: {
        ...
        usage:
          'shadowob app call flash cards.update --server "<server>" --json-input \'{"cardId":"<card>","x":320,"y":240}\' --json',
        details:
    ...
    },
    {
      ...
      help: {
        ...
        usage:
          'shadowob app call flash assets.upload --server "<server>" --file ./image.png --json-input \'{}\' --json',
        details:
    ...
    },
    {
      ...
      help: {
        ...
        usage:
          'shadowob app call flash selection.update --server "<server>" --json-input \'{"selectedCardIds":["<card>"]}\' --json',
        details:
  ...
  realtime: {
    ...
    subscribe: {
      ...
      help: 'Use shadowob app events flash --server "<server>" --json for Shadow command lifecycle events. Browser clients subscribe directly to the Flash board event stream with the Shadow launch token; local dev uses the same board SSE endpoint.',
    },
    publish: {

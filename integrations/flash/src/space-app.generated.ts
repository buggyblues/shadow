...
export const shadowSpaceAppManifest = {
  ...
  marketplace: {
    ...
    categories: ['Creation', 'Productivity', 'Tools'],
  ...
  help: {
    ...
    usage:
      "Use shadowob space-app call flash <command> --server <server> --channel-id <channel> --json-input '<input-json>' --json. Use --help on a specific command for detailed schema and examples.",
    commandIndex:
      'Use boards.get for snapshots, cards.create/cards.update for typed cards, assets.upload or cards.create --file for local images, selection.get for the current stored selection, and shadowob space-app events flash for realtime updates.',
  },
  commands: [
    {
      name: 'boards.get',
    ...
    },
    {
      ...
      help: {
        ...
        usage:
          'shadowob space-app call flash cards.create --server "<server>" --channel-id "<channel>" --json-input \'{"kind":"image","title":"Sketch"}\' --file ./sketch.png --json',
        details:
        ...
        examples: [
          {
            ...
            command:
              'shadowob space-app call flash cards.create --server "<server>" --channel-id "<channel>" --json-input \'{"kind":"image","title":"Moodboard"}\' --file ./moodboard.png --json',
          },
          {
    ...
    },
    {
      ...
      help: {
        ...
        usage:
          'shadowob space-app call flash cards.update --server "<server>" --json-input \'{"cardId":"<card>","x":320,"y":240}\' --json',
        details:
    ...
    },
    {
      ...
      help: {
        ...
        usage:
          'shadowob space-app call flash assets.upload --server "<server>" --file ./image.png --json-input \'{}\' --json',
        details:
    ...
    },
    {
      ...
      help: {
        ...
        usage:
          'shadowob space-app call flash selection.get --server "<server>" --channel-id "<channel>" --json-input \'{}\' --json',
      },
      ingress: {
    ...
    },
    {
      ...
      help: {
        ...
        usage:
          'shadowob space-app call flash selection.update --server "<server>" --json-input \'{"selectedCardIds":["<card>"]}\' --json',
        details:
  ...
  skills: [
    {
      ...
      commandHints: [
        ...
        'flash selection.get',
        'flash cards.create',
        'flash cards.create --file ./image.png',
        'flash assets.upload --file ./image.png',
        'flash cards.update',
        'flash rooms.attach',
        'flash cards.command',
        'flash arenas.create',
        'flash arenas.activate',
        'shadowob space-app events flash',
      ],
    },
  ],
  events: [
  ...
  realtime: {
    ...
    subscribe: {
      events: ['flash.events.appended', 'flash.selection.updated', 'space_app.command.completed'],
      help: 'Use shadowob space-app events flash --server "<server>" --json for Shadow command lifecycle events. Browser clients subscribe directly to the Flash board event stream with the Shadow launch token; local dev uses the same board SSE endpoint.',
    },
    publish: {
  ...
  i18n: {
    'zh-CN': {
      name: '闪卡',
      description:
        '持久化多卡片画布，支持实时房间、服务端命令执行、文件图片卡片和 Buddy 辅助操作。',
      marketplace: {
        tagline: '用于构建、排列和分享想法的可视化卡片画布。',
        summary:
          '闪卡为服务器提供持久化创作画布，支持卡片、图片、代码、图表、时间线、扑克、塔罗、Live2D、Three.js 场景和实时协作。成员和 Buddy 可以创建卡片、上传素材、发布看板状态，并把视觉工作整理在一个共享空间里。',
        categories: ['创作', '效率', '工具'],
        gallery: [
          {
            alt: '闪卡封面',

...
export const shadowSpaceAppManifest = {
  ...
  name: 'Answers',
  description:
    'A Q&A app for tagged questions, Markdown articles, reading batches, personal lists, full Markdown answers, comments, image uploads, search, delete actions, and Buddy participation.',
  version: '1.0.0',
  iconUrl: 'http://localhost:4210/assets/icon.svg',
  marketplace: {
    tagline: 'A server knowledge base where questions and articles become reusable reading.',
    summary:
      'Answers helps a server collect tagged questions, Markdown answers, long-form articles, reading batches, comments, images, search results, and Buddy participation. Use it for team FAQs, study groups, support communities, and long-lived knowledge that should stay searchable.',
  ...
  commands: [
    ...
    },
    {
      ...
      description: 'Upload an image that can be embedded in Markdown question context or answers.',
      help: {
        summary: 'Upload an image and use the returned URL in Markdown.',
        usage:
          'shadowob space-app call answers images.upload --server "<server>" --file ./diagram.png --json',
  ...
  skills: [
    {
      ...
      description:
        'Use when a Buddy needs to search tagged questions, publish or read Markdown articles, manage personal Q&A lists, use reading batches, ask a question, upload images, answer with Markdown, or comment.',
      commandHints: [
        'answers questions.list',
        'answers questions.get',
        'answers articles.list',
        'answers articles.get',
        'answers articles.publish',
        ...
        'answers reading.batches',
        'answers reading.mark_read',
  ...
  i18n: {
    'zh-CN': {
      name: '问问',
      description:
        '问答应用，支持标签问题、Markdown 文章、阅读清单、个人列表、Markdown 回答、评论、图片上传、搜索、删除和 Buddy 参与。',
      marketplace: {
        tagline: '把问题和文章沉淀成可复用阅读的服务器知识库。',
        summary:
          '问问帮助服务器收集带标签的问题、Markdown 回答、长文章、阅读清单、评论、图片、搜索结果和 Buddy 参与记录。适合团队 FAQ、学习小组、支持社区和需要长期可搜索的知识沉淀。',
        categories: ['知识', '协作', '工具'],
        gallery: [
          {
            alt: '问问封面',

...
Use this reference when creating a new Shadow App. The scaffold must stay domain-neutral so agents can build the user's requested App instead of copying a particular existing application.

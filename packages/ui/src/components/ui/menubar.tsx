...
>(({ className, ...props }, ref) => (
  <MenubarPrimitive.Root
    ref={ref}
    className={cn(
      'flex h-12 items-center space-x-1 rounded-2xl border border-border-subtle bg-bg-secondary/80 p-1 shadow-sm backdrop-blur-md',
      className,
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <MenubarPrimitive.Trigger
    ref={ref}
    className={cn(
      'flex cursor-default select-none items-center rounded-xl px-3 py-1.5 text-sm font-black uppercase tracking-widest outline-none focus:bg-bg-tertiary data-[state=open]:bg-bg-tertiary data-[state=open]:text-primary transition-all',
      className,
    )}
    {...props}
  />
...
>(({ className, inset, children, ...props }, ref) => (
  <MenubarPrimitive.SubTrigger
    ref={ref}
    className={cn(
      'flex cursor-default select-none items-center rounded-xl px-2 py-1.5 text-sm font-bold outline-none focus:bg-primary focus:text-bg-deep data-[state=open]:bg-primary data-[state=open]:text-bg-deep transition-all',
      inset && 'pl-8',
      className,
    )}
    {...props}
...
>(({ className, inset, ...props }, ref) => (
  <MenubarPrimitive.Item
    ref={ref}
    className={cn(
      'relative flex cursor-default select-none items-center rounded-xl px-2 py-1.5 text-sm font-bold outline-none focus:bg-primary focus:text-bg-deep data-[disabled]:pointer-events-none data-[disabled]:opacity-50 transition-all active:scale-[0.98]',
      inset && 'pl-8',
      className,
    )}
    {...props}
...
>(({ className, children, checked, ...props }, ref) => (
  <MenubarPrimitive.CheckboxItem
    ref={ref}
    className={cn(
      'relative flex cursor-default select-none items-center rounded-xl py-1.5 pl-8 pr-2 text-sm font-bold outline-none focus:bg-primary focus:text-bg-deep data-[disabled]:pointer-events-none data-[disabled]:opacity-50 transition-all',
      className,
    )}
    checked={checked}
    {...props}
...
>(({ className, inset, ...props }, ref) => (
  <MenubarPrimitive.Label
    ref={ref}
    className={cn(
      'px-2 py-1.5 text-[10px] font-black uppercase tracking-[0.2em] text-text-muted/50',
      inset && 'pl-8',
      className,
    )}
    {...props}

...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      'inline-flex h-12 items-center justify-center rounded-[28px] bg-[var(--glass-bg)] p-1.5 border border-border-subtle shadow-[inset_0_1px_0_rgba(255,255,255,0.06)] backdrop-blur-[20px]',
      className,
    )}
    {...props}
  />

...
>(({ className, sideOffset = 0, alignOffset = -4, ...props }, ref) => (
  <DropdownMenuPrimitive.Portal>
    <DropdownMenuPrimitive.SubContent
      ...
      className={cn(
        'shadow-dropdown-content z-50 min-w-[8rem] overflow-hidden rounded-[24px] border border-border-subtle bg-bg-secondary/95 p-1 text-text-primary shadow-[0_20px_60px_rgba(0,0,0,0.4)] backdrop-blur-xl',
        className,
      )}
      {...props}
    />
...
>(({ className, sideOffset = 4, ...props }, ref) => (
  <DropdownMenuPrimitive.Portal>
    <DropdownMenuPrimitive.Content
      ...
      sideOffset={sideOffset}
      className={cn(
        'shadow-dropdown-content z-50 min-w-[12rem] overflow-hidden rounded-[24px] border border-border-subtle bg-bg-secondary/95 p-1 text-text-primary shadow-[0_20px_60px_rgba(0,0,0,0.4)] backdrop-blur-xl',
        className,
      )}
      {...props}
    />

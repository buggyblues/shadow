...
发现 API 展示热门和趋势内容 —— Space、频道、店铺、Buddy 和公开 Space 资源 —— 供用户探索。
...
返回热门 Space、活跃频道和公开 Space 内容的排名列表。无需认证。
...
搜索公开 Space、频道、店铺、Buddy 和公开资源。无需认证。
...
返回面向发现页的购买入口聚合，包含 Buddy、服务与内容、店铺和公开 Space。需要登录。

...
execSync('npx rspack build -c rspack.main.config.mjs --mode production', { cwd: root, stdio: 'inherit', env })

console.log('[build] Building preload...')
execSync('npx rspack build -c rspack.preload.config.mjs --mode production', { cwd: root, stdio: 'inherit', env })

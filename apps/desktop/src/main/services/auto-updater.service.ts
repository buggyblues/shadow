...
export class AutoUpdaterService {
  ...
  async setUpdateSettings(incoming: Partial<UpdateSettings>): Promise<UpdateSettings> {
  ...
  async downloadUpdate(downloadUrl: string): Promise<boolean> {

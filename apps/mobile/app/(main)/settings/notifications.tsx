...
import { BackgroundSurface, MenuItem, PageScroll, Section } from '../../../src/components/ui'
...
export default function NotificationSettingsScreen() {
  ...
  return (
    <BackgroundSurface style={styles.container}>
      ...
      <PageScroll compact>
        <Section title={t('settings.notificationStrategy')}>
          {strategies.map((s) => {
            ...
            return (
              <MenuItem
                ...
                right={active ? <Check size={iconSize.md} color={colors.primary} /> : null}
              />
            )
          })}
        </Section>

...
const runtimeDependencies: PluginRuntimeDependency[] = [
  ...
  },
  {
    ...
    command: [
      [
        ...
        "cat > /runtime-deps/python/sitecustomize.py <<'SHADOW_TEXT_TO_CAD_SITE_CUSTOMIZE'",
        'try:',
        ...
        'except Exception:',
        '    pass',
        'SHADOW_TEXT_TO_CAD_SITE_CUSTOMIZE',
      ].join('\n'),
    ],
  ...
  },
  {
    ...
    command: [
      [
        "python3 - <<'SHADOW_TEXT_TO_CAD_PATCH_SKILLS'",
        ...
        'SHADOW_TEXT_TO_CAD_PATCH_SKILLS',
      ].join('\n'),
    ],

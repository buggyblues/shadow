...
/**
 * Get display label for rule type - uses i18n
 */
export function useRuleTypeLabel(ruleType: ChannelPostingRuleType): string {
...
/**
 * Get description for rule type - uses i18n
 */
export function useRuleTypeDescription(ruleType: ChannelPostingRuleType): string {
  const { t } = useTranslation()
 ...
 * @deprecated Use useRuleTypeLabel instead
 */
...
/**
 * Legacy function - kept for backward compatibility
 * @deprecated Use useRuleTypeDescription instead
 */

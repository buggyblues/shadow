...
<style>
  ...
  * { margin:0; padding:0; box-sizing:border-box; }
  ...
  .badge {
    ...
    font-size: 11px; color: var(--accent-cyan); font-weight: 800;
    margin-top: 4px; text-transform: uppercase; letter-spacing: 0.5px;
  }
  .badge::before {
    content: ''; width: 6px; height: 6px; border-radius: 50%;
    background: var(--accent-cyan); animation: floatAnim 2s ease-in-out infinite;
  }
  ...
  .quick-start h2 {
    font-size: 16px; font-weight: 900; color: var(--text-primary); margin-bottom: 6px;
    display: flex; align-items: center; gap: 8px;
  }
  .quick-start p { color: var(--text-muted); font-size: 14px; font-weight: 700; line-height: 1.6; }
  ...
  .feature-card h3 {
    font-size: 14px; font-weight: 900; color: var(--text-primary); margin-bottom: 5px;
  }
  .feature-card p {
    font-size: 12px; color: var(--text-muted); font-weight: 700; line-height: 1.5;
  }
